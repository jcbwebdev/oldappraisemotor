        ...
        <div class='grid-x grid-margin-x grid-margin-y '>
            ...
            <div class='medium-8 small-order-1 medium-order-2 cell'>
                ...
                <form action="passwordresetExec.php" name="passreset" enctype="multipart/form-data" method="post" class="standard">
                    ...
                    <p>
                        <label for="Password1">New Password:</label><input type="password" name="Password1" id="Password1" value="<?php echo check_output($_SESSION['Password1']); ?>" placeholder="PASSWORD"/>
                    </p>
                    <p>
                        <label for="Password2">Repeat:</label><input type="password" name="Password2" id="Password2" value="<?php echo check_output($_SESSION['Password2']); ?>"/>
                    </p>
                    <p>
