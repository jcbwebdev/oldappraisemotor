	...
	if (is_array($Users) && count($Users) == 1)
	{
        ...
        else
        {
            ...
            if ($result === true) {
                ...
                $_SESSION['Message'] = array('Type'=>'success','Message'=>"Please check your email for details of how to reset your password. Be sure to check your junk email folder and ensure any further emails from ".$sitename." are set as ‘safe’.");
            } else {
                $_SESSION['Message'] = array('Type'=>'error','Message'=>"Sorry - there was a problem resetting your password. Please check the email address matches your account or <a href='/contact/'>contact us</a>.");
            }
