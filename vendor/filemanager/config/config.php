<?php
    ...
    if (!isset($_SESSION['UserDetails']) || ($_SESSION['UserDetails']['AdminLevel'] != 'F' && $_SESSION['UserDetails']['AdminLevel'] != 'E')) { die(); }
    ...
    */
    ...
    $config = array(
        ...
        */
        ...
        |
        */
        'thumbs_base_path' => '../../user_upload_thumbs/',
        ...
        |
        */
        'thumbs_upload_dir' => '/user_upload_thumbs/',
